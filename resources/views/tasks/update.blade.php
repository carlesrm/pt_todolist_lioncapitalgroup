...
@section('content')
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">Actualizar tarea</h2>

        <form method="POST" action="{{route('tasks.update.post', $task->id)}}" class="space-y-4">
            @csrf
            {{--  Título  --}}
            <div>
            ...
            <div>
                ...
                <textarea
                    ...
                    placeholder="Escribe aquí en que consiste la tarea."
